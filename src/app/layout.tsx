...
export const metadata: Metadata = {
  ...
  // PWA + web-push prerequisites. The apple-touch-icon is generated by
  // src/app/apple-icon.tsx; iOS Safari needs it to be a *physical* file
  // linked from <head>, not a favicon override, or it ignores the path.
  // Same for the manifest — without these tags OneSignal cannot register
  // an iOS 16.4+ subscription and Chrome still treats the install as a
  // plain bookmark on Android.
